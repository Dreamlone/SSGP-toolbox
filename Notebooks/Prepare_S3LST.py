...
Preparator_S3LST = S3_L2_LST(file_path = os.path.join(os.pardir, 'Samples', 'S3LST_preparation_example', 'source',
...
Preparator_S3LST.save_metadata(output_path = os.path.join(os.pardir, 'Samples', 'S3LST_preparation_example','prepared', '20190831T194258_metadata.json'))
...
# Run reconstruction. Just set path to NPY and saved metadata, and to output GeoTiff
reconstruct_geotiff(npy_path = os.path.join(os.pardir, 'Samples', 'S3LST_preparation_example', 'prepared','20190831T194258.npy'),
                    metadata_path = os.path.join(os.pardir, 'Samples', 'S3LST_preparation_example','prepared','20190831T194258_metadata.json'),
                    output_path = os.path.join(os.pardir, 'Samples', 'S3LST_preparation_example', 'prepared', '20190831T194258_reconstructed.tif'))
